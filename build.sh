...
i686-elf-gcc -T link.ld -o build/image.elf -ffreestanding -nostdlib build/boot.o build/kernel.o build/video.o build/interrupt.o build/_interrupt.o build/io.o build/keyboard.o build/_keyboard.o  build/string.o -lgcc
